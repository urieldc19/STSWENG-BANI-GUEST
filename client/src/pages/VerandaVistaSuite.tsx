...
const coverImage = './images/room-cover/Veranda.png';

const slideshowImages = [
  './images/veranda-vista/veranda-1.png',
  './images/veranda-vista/veranda-2.png',
  './images/veranda-vista/veranda-3.png',
  './images/veranda-vista/veranda-4.png',
];

const VerandaVistaSuite = () => {
  return (
    <div className="flex flex-col w-full min-h-screen" style={{ fontFamily: 'Inria Serif' }}>
      <img src={coverImage} alt="Veranda Vista Suite Cover" className="w-full h-auto object-cover" />
      ...
      <section className="max-w-6xl mx-auto my-16 px-5 flex flex-col md:flex-row">
        <div className="flex-1 pr-10 text-left">
          <h2 className="text-3xl md:text-5xl font-bold mb-4">Discover the Tranquil Charm of the Veranda Vista Suite!</h2>
        </div>
        <div className="flex-1 text-left">
          <p className="text-lg md:text-xl">
            Escape to the Veranda Vista Suite, your private haven on the second floor, where breathtaking mountain and sea views set the perfect backdrop for relaxation. This suite offers an inviting atmosphere, ideal for families and small groups looking to create lasting memories. Enjoy the tranquility of your surroundings as you step out onto your exclusive veranda, perfect for morning coffees or evening sunsets. Experience the comfort and charm of your beach getaway in a space designed for unforgettable moments with loved ones.
          </p>
        </div>
      </section>
      ...
      <div className="text-center mb-4">
        ...
        <p className="text-2xl md:text-3xl" style={{ fontSize: '25px' }}>Location: Second Floor | ₱11,000.00</p>
      </div>
      ...
      <div className="flex flex-col md:flex-row justify-between mb-6 mx-auto max-w-5xl">
        <div className="w-full md:w-1/2 p-4 bg-[#A0B1B5]/50 rounded-md shadow-md mb-4 md:mr-2 text-left">
          ...
          <ul className="list-disc list-outside pl-5 text-lg mb-4">
            <li>Bed Configuration: 2 queen-size beds and 1 single bed bunk</li>
            ...
            <li>Outdoor Space: Exclusive access to the veranda with mountain and sea views</li>
          </ul>
          <p className="text-lg font-semibold">Pricing:</p>
          <p>₱11,000.00 for 6 pax</p>
      ...
      <div className="flex justify-center mt-6 mb-6">
        <Link to="/reservations">
          <button 
            ...
            aria-label="Book the Veranda Vista Suite"
          >
            Book Now
          </button>
        </Link>
...
export default VerandaVistaSuite;
