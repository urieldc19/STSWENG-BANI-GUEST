  ...
  return (
    <div className="flex flex-col w-screen" style={{ fontFamily: 'Inria Serif' }}>
      ...
      <section className="max-w-6xl mx-auto my-16 px-5 flex">
        <div className="flex-1 pr-10 text-left" style={{ marginLeft: '-100px' }}>
          <h2 className="text-[55px] font-bold mb-4">Experience Unmatched <br />Comfort at Our Resort</h2>
        </div>
        <div className="flex-1 text-left" style={{ marginRight: '-100px' }}>
  ...
  <h3 className="text-white text-[55px] font-bold">AMENITIES</h3>
      ...
      <div className="text-center my-4">
        <p className="text-[25px]">
          At our resort, we aim to provide a seamless blend of relaxation, recreation, < br/> and comfort with a variety of amenities that cater to your every need.
        </p>
      </div>
