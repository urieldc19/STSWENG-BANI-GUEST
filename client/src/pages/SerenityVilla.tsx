...
const SerenityVilla = () => {
  return (
    <div className="flex flex-col w-full min-h-screen" style={{ fontFamily: 'Inria Serif' }}>
      <img src={coverImage} alt="Serenity Villa Cover" className="w-full h-auto object-cover" />
      ...
      <section className="max-w-6xl mx-auto my-16 px-5 flex flex-col md:flex-row">
        <div className="flex-1 pr-10 text-left">
          <h2 className="text-3xl md:text-5xl font-bold mb-4">Relax and Unwind in the Serenity Villa!</h2>
        </div>
      ...
      <div className="text-center mb-4">
        ...
        <p className="text-2xl md:text-3xl" style={{ fontSize: '25px' }}>₱15,000.00</p>
      </div>
